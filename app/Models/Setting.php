...
{
    protected $fillable = ['nama_desa', 'tagline', 'deskripsi_hero', 'hero_image', 'hero_video', 'nama_kepala_desa', 'periode_kepala_desa', 'sambutan', 'foto_kepala_desa', 'nama_sekretaris_desa', 'jabatan_sekretaris_desa', 'lokasi_sekretaris_desa', 'stat_pendidikan', 'stat_umkm', 'stat_wisata', 'stat_embung', 'alamat', 'email', 'jam_operasional', 'whatsapp_admin', 'instagram', 'facebook', 'youtube', 'maps_embed', 'sop_pengajuan', 'estimasi_proses', 'kontak_darurat'];
