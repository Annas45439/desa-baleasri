...
class ApbdesController extends Controller
{
    ...
    {
        $data = $request->validate(['tahun' => ['required', 'integer', 'min:2000', 'max:2100'], 'jenis' => ['required', 'in:Pendapatan,Belanja,Pembiayaan'], 'nama' => ['required', 'string', 'max:180'], 'anggaran' => ['required', 'numeric', 'min:0'], 'realisasi' => ['required', 'numeric', 'min:0'], 'keterangan' => ['nullable', 'string']]);
        Apbdes::create($data);
