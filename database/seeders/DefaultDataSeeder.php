...
class DefaultDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ([['Kain Batik Gedhek', 'Batik'], ['Sandal Kain Perca', 'Kerajinan'], ['Dompet Kulit Asli', 'Kerajinan Kulit'], ['Tas Anyaman Jali', 'Anyaman'], ['Keripik Buah Lokal', 'Olahan']] as $index => [$nama, $tag]) {
            Potensi::updateOrCreate(['nama' => $nama, 'kategori' => 'umkm'], ['tag' => $tag, 'tampil' => true, 'urutan' => $index]);
        }
